...
import "github.com/buke/typescript-go-internal/pkg/stringutil"

//go:generate go run generate.go -output ./diagnostics_generated.go
//go:generate go run golang.org/x/tools/cmd/stringer@latest -type=Category -output=stringer_generated.go
//go:generate go run mvdan.cc/gofumpt@latest -w diagnostics_generated.go stringer_generated.go
