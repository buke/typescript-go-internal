...
//go:generate go run golang.org/x/tools/cmd/stringer@latest -type=ExportKind -output=autoImports_stringer_generated.go
//go:generate go run mvdan.cc/gofumpt@latest -w autoImports_stringer_generated.go
